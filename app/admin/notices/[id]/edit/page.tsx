...
import { updateNoticeAction } from "@/app/admin/actions"
import { TiptapEditor } from "@/components/forms/tiptap-editor"
import { getNoticeById, getNoticeCategories } from "@/lib/db"
...
import { EditNoticeSubmitButtons } from "./submit-buttons"
...
export default async function EditNoticePage({ params }: EditNoticePageProps) {
  ...
  return (
    <div className="w-full max-w-full space-y-6">
      <PageHeader
        title="Edit Notice"
        description="Update notice content, publishing settings, and attachments."
        action={
      ...
      <form action={updateNoticeAction.bind(null, notice.id)} className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="rounded-xl border border-border bg-white p-6 shadow-2xs space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Select name="notice_type" defaultValue={notice.notice_type || "general"}>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                name="publish_date"
                type="datetime-local"
                defaultValue={notice.publish_date ? notice.publish_date.slice(0, 16) : ""}
                className="h-10 text-sm border-[#CBD5E1]"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select name="published" defaultValue={notice.published ? "true" : "false"}>
