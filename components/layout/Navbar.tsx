...
const menuItems = [
  ...
  },
  {
    ...
    icon: Users,
    children: [
      { label: "সভাপতি", href: "/leadership/president" },
      { label: "অধ্যক্ষ", href: "/principal" },
              ...
              {menuItems.map((item) => {
                ...
                if (item.href) {
                  return (
                    <Link
                      key={item.label}
                      href={item.href}
                      className={`relative px-4 py-2 text-[17px] font-semibold rounded-md transition-colors duration-200 ${active
                ...
                return (
                  <div key={item.label} className="relative group">
                    <button
                      type="button"
                      className={`inline-flex items-center gap-1.5 px-4 py-2 text-[17px] font-semibold rounded-md transition-colors duration-200 ${active
                          ? "text-[#075E54] bg-[#F0F7F5]"
                        ...
                        {children.map((child) => {
                          ...
                          return (
                            <Link
                              key={child.href}
                              href={child.href}
                              className={`flex items-center justify-between rounded-lg px-3.5 py-2.5 text-[16px] transition-colors duration-150 ${childActive
                            ...
                            >
                              ...
                              <ChevronRight
                                className={`h-4 w-4 ${childActive ? "text-white/80" : "text-[#5F6B67]"
                                  }`}
                              />
                            </Link>
                          )
                  ...
                  return (
                    <div key={item.label} className="pt-1.5 first:pt-0">
                      <Link
                        ...
                        className={`flex items-center justify-between rounded-lg px-3.5 py-3 text-[17px] font-semibold transition-colors ${active
                ...
                return (
                  <div key={item.label} className="pt-1.5 first:pt-0">
                    <button
                      ...
                      className={`flex w-full items-center justify-between rounded-lg px-3.5 py-3 text-[17px] font-semibold transition-colors ${active
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`h-4 w-4 text-[#5F6B67] transition-transform duration-200 ${isExpanded ? "rotate-180 text-[#075E54]" : ""
                          }`}
                      />
                    </button>
                        ...
                        {children.map((child) => {
                          ...
                          return (
                            <Link
                              ...
                              href={child.href}
                              onClick={() => setMobileMenuOpen(false)}
                              className={`flex items-center justify-between rounded-md px-3.5 py-2.5 text-[16px] transition-colors ${childActive
                                  ? "bg-[#075E54] text-white font-semibold"
                                  : "text-[#17211E] font-medium hover:bg-[#F7F8F5] hover:text-[#075E54]"
                                }`}
                            >
