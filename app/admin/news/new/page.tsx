...
import { getNewsCategories } from "@/lib/db"
...
import { NewNewsSubmitButtons } from "./submit-buttons"
...
export default async function NewNewsPage() {
  ...
  return (
    <div className="w-full max-w-full space-y-6">
      <PageHeader
        title="Add New News"
        description="Create school news article details, content, featured image, and status."
        action={
      ...
      <form action={createNewsAction} className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
