...
import { StaffEditActions } from "@/components/admin/staff-edit-actions"
import { StaffProfilePhotoField } from "@/components/admin/staff-profile-photo-field"
...
export default async function EditStaffPage({ params, searchParams }: EditStaffPageProps) {
  ...
  const [staff, addresses, governmentInfo, academics, experience, training, family] = await Promise.all([
    getStaffProfile(id),
  ...
  return (
    <div className="w-full max-w-full space-y-6">
      <PageHeader
        ...
        description={`Editing profile for ${staff.full_name_en ?? "Unnamed"} (ID: ${staff.employee_id ?? "N/A"})`}
        action={
      ...
      <form id="staff-edit-form" action={updateStaffAction.bind(null, staff.id)} noValidate className="space-y-6">
        {/* 1. Basic Information */}
        <div className="rounded-xl border border-border bg-card p-6 shadow-2xs">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="space-y-1.5">
              ...
              <Input id="full_name_bn" name="full_name_bn" defaultValue={staff.full_name_bn ?? ""} className="h-10 text-sm border-input bg-background" />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input id="signature" name="signature" defaultValue={staff.signature ?? ""} className="h-10 text-sm border-input bg-background" />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <FormDatePicker
                ...
                defaultValue={normalizeDateForInput(staff.date_of_birth)}
            ...
            <div className="space-y-1.5">
              ...
              <FormSelect
                id="marital_status"
                name="marital_status"
                defaultValue={staff.marital_status ?? ""}
            ...
            <div className="space-y-1.5">
              ...
              <Input id="nationality" name="nationality" defaultValue={staff.nationality ?? "Bangladeshi"} className="h-10 text-sm border-input bg-background" />
            </div>
            ...
            <div className="space-y-1.5 md:col-span-2 lg:col-span-3 pt-2">
              <StaffProfilePhotoField staffId={id} currentPhotoUrl={staff.profile_photo} />
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-2xs">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <div className="space-y-1.5">
              ...
              <Input id="employee_id" name="employee_id" defaultValue={staff.employee_id ?? ""} disabled className="h-10 text-sm border-input bg-muted/40 text-muted-foreground" />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="designation" className="text-sm font-bold text-foreground">
                Designation
              </Label>
              <Input id="designation" name="designation" defaultValue={staff.designation ?? ""} className="h-10 text-sm border-input bg-background" />
            </div>
            <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              ...
              <Input id="subject" name="subject" defaultValue={staff.subject ?? ""} className="h-10 text-sm border-input bg-background" />
            </div>
            <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              ...
              <FormDatePicker id="joining_date" name="joining_date" defaultValue={normalizeDateForInput(staff.joining_date)} placeholder="DD/MM/YYYY" />
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-2xs">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="space-y-1.5">
              ...
              <Input id="alt_contact_number" name="alt_contact_number" defaultValue={staff.alt_contact_number ?? ""} className="h-10 text-sm border-input bg-background" />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input id="emergency_contact" name="emergency_contact" defaultValue={staff.emergency_contact ?? ""} className="h-10 text-sm border-input bg-background" />
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-2xs">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <div className="space-y-1.5">
              ...
              <Input id="nid_number" name="nid_number" defaultValue={staff.nid_number ?? ""} className="h-10 text-sm border-input bg-background" />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="birth_certificate" className="text-sm font-bold text-foreground">
                Birth Certificate Number
              </Label>
              <Input id="birth_certificate" name="birth_certificate" defaultValue={staff.birth_certificate ?? ""} className="h-10 text-sm border-input bg-background" />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="passport_number" className="text-sm font-bold text-foreground">
                Passport Number
              </Label>
              <Input id="passport_number" name="passport_number" defaultValue={staff.passport_number ?? ""} className="h-10 text-sm border-input bg-background" />
            </div>
          </div>
        </div>
        ...
        <StaffEditActions staffId={staff.id} formId="staff-edit-form" />
      </form>
    </div>
  )
}
